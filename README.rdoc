...
If you want to open the page in a new tab hold down the Alt key as well.

If you add the Tea Time button to your toolbar you can also open a new page by
clicking on the icon (Ctrl or Cmd click to open in a new tab). There is also a
dropdown menu with your reading list next to the icon.
